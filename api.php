    ...
    case 'get_about':
        ...
        echo json_encode([
            ...
            'data' => [
                ...
                'changelog' => [
                    ['version' => '2.5.0', 'date' => '2025-05-04', 'note' => '全面优化版：安全加固、模糊搜索、搜索历史、打印证书、日志导出CSV、多模板证书系统、键盘快捷键、无障碍优化、打印样式、深色模式增强'],
                    ['version' => '2.0.0', 'date' => '2025-04-01', 'note' => '新增SSTV辅助工具、证书验证、荣誉墙、月度排行、Webhook推送、批量导出、趋势图表'],
                    ['version' => '1.0.0', 'date' => '2025-01-01', 'note' => '初始版本：证书查询、下载、分享、后台管理']
                ],
                'license' => '公益服务平台，仅供湖北FMO中继台使用',
                'copyright' => '© 2025 湖北FMO中继台'
            ]
        ], JSON_UNESCAPED_UNICODE);
        break;
